...
$_title = 'Flot - Statistics - SmartAdmin v4.0.3';
            ...
            $(document).ready(function()
            {
                ...
                },
                {
                    ...
                    bars:
                    {
                        show: true,
                        lineWidth: 0,
                        fillColor: myapp_get_color.primary_500
                    }
                }],
                {
                    grid:
                ...
                var flotLine = $.plot($('#flot-line'), [
                {
                    data: dataSet1,
                    label: 'New Customer',
                    color: myapp_get_color.primary_400
                },
                {
                    data: dataSet2,
                ...
                {
                    colors: [myapp_get_color.primary_500],
                    series:
                    {
                        lines:
                        {
                ...
                {
                    colors: [myapp_get_color.primary_200],
                    series:
                    {
                        lines:
                        {
